...
const lastStyleIndex = code.lastIndexOf('const styles = StyleSheet.create({');
if (lastStyleIndex !== -1) {
    const mainLastIndex = code.indexOf('});', lastStyleIndex);
    const textBefore = code.substring(0, mainLastIndex);
    const textAfter = code.substring(mainLastIndex + 3);
  ...
  reviewSubmitText: {
    ...
    code = textBefore + extraStyles + textAfter;
}
